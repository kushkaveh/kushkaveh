...
**NexaPortal Group · 2023 – 2025**

Co-founded and helped operate an AI-powered product studio focused on healthtech, CRM systems, and digital product design.
...
Production AI systems for fintech workflows.

**Scope**

- RAG assistant  
- Agentic workflow automation  
- CRM-connected AI operations  
...
- Served a live platform with 20,000+ users  
- Reduced targeted manual overhead by ~70%  
- Created scalable AI workflows for internal and external users  
...
AI-powered health tourism platform.
...
- AI-assisted patient matching concept  
- Clinic and patient workflows  

**Recognition**

- A' Design Award Bronze  
- Mobile Technologies & Software Design  
- 2025  
...
Enterprise CRM for international patient and clinic operations.

**Scope**

- B2B SaaS UX  
- Multi-stakeholder workflows  
- Lead and patient pipeline systems  
- Clinic operation flows  
- Design system  
- Engineering handoff  
...
- Reduced design-to-development handoff time by 35%  
- Supported complex health tourism workflows  
...
Packaging and product identity system.
